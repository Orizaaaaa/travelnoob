            ...
            <View className='justify-between h-40 px-5' >
                ...
                <View className='flex-row justify-center mt-10'>
                    ...
                    {slidesAsset.map((_, index) => (
                        <View key={index} className='bg-primary'
                            style={[styles.indicator, currentSlideIndex == index && { width: 34, height: 8, backgroundColor: '#24BAEC' },]}
                        />
                    ))}
                </View>
                ...
                <View className='mb-5'>
                    {currentSlideIndex == slidesAsset.length - 1 ? (
                        <View className='h-12'>
                            <ButtonPrimary onPress={() => navigation.navigate('MainScreen')} className='flex-1 h-12 rounded-md' >
                        ...
                        <View className='flex-row ' >
                            ...
                            <ButtonPrimary onPress={goToNextSlide} className='flex-1 h-12 rounded-md'>
